...
- Randomized trials are the gold standard workhorse of medical evidence, but are generally not feasible for most trainees to substantively contribute to, owing to the time required, regulatory burden, and resources required. 

:::

## What Kind of Mentor(s) Do You Need? {#sec-mentor}
...
Figure idea: How do you find a good study question? (unique dataset? unique analysis? - why hasn’t it been done before?)
